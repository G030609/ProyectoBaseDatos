...
<body>
    ...
    <table border="1" align="center" class="table">
        <tr>
            <td style="background-color: #57E307;">Ide de usuario</td>
            <td style="background-color: #57E307;">Nombre de usuario</td>
            <td style="background-color: #57E307;">Contraseña</td>
            <td style="background-color: #57E307;">Perfil de usuario</td>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $mostrar['perfilUsuario'] ?></td>
