...
<header align="center">
    <h1>Vista sencilla que muestra los usuarios y los perfiles</h1>
</header>
...
<body>
    ...
    <table border="1" align="center" class="table">
        <tr>
            ...
            <td style="background-color: #57E307;">Nombre del perfil</td>
          
        </tr>
        <?php
        $sql = "SELECT * FROM plantas.usuarios_y_perfiles;";
