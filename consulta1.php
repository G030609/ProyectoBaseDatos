...
<header align="center">
    <h1>Consulta relacional que muestra la planta, su categoria y el nombre del descubridor</h1>
</header>
...
<body>
    ...
    <table border="1" align="center" class="table">
        ...
        <?php
        $sql = "SELECT p.nombre_planta,c.nombre_categoria, d.nombre_descubridor from planta as p
