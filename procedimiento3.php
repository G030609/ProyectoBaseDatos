...
<body>
    ...
    <table border="1" align="center" class="table">
        <tr>
            <td style="background-color: #57E307;">Ide Planta</td>
            <td style="background-color: #57E307;">Nombre de la planta</td>
            <td style="background-color: #57E307;">Descripcion</td>
            <td style="background-color: #57E307;">Lugar de origen</td>
        ...
        ?>
            <tr>
                ...
                <td><?php echo $mostrar['lugar_origen'] ?></td>
